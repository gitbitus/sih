...
export default function ServerErrorPage() {
  ...
  // Stubs for other files to avoid missing imports
  'src/pages/public/VerifyPage.tsx': 'export default function VerifyPage() { return <div>Verify Page</div>; }',
  'src/pages/public/ComplaintPage.tsx': 'export default function ComplaintPage() { return <div>Complaint Page</div>; }',
  'src/pages/auth/MerchantRegisterPage.tsx': 'export default function MerchantRegisterPage() { return <div>Merchant Register</div>; }',
  'src/pages/merchant/ApplicationFormPage.tsx': 'export default function ApplicationFormPage() { return <div>Application Form</div>; }',
  'src/pages/merchant/ApplicationListPage.tsx': 'export default function ApplicationListPage() { return <div>Application List</div>; }',
  'src/pages/merchant/ApplicationDetailPage.tsx': 'export default function ApplicationDetailPage() { return <div>Application Detail</div>; }',
  'src/pages/merchant/CertificatesPage.tsx': 'export default function CertificatesPage() { return <div>Certificates</div>; }',
  'src/pages/admin/RequestListPage.tsx': 'export default function RequestListPage() { return <div>Requests List</div>; }',
  'src/pages/admin/RequestDetailPage.tsx': 'export default function RequestDetailPage() { return <div>Request Detail</div>; }',
  'src/pages/admin/SubAdminManagePage.tsx': 'export default function SubAdminManagePage() { return <div>Sub Admin Manage</div>; }',
  'src/pages/admin/ComplaintsPage.tsx': 'export default function ComplaintsPage() { return <div>Complaints</div>; }',
  'src/pages/admin/AuditLogPage.tsx': 'export default function AuditLogPage() { return <div>Audit Log</div>; }',
  'src/pages/subAdmin/VisitsPage.tsx': 'export default function VisitsPage() { return <div>Visits</div>; }',
  'src/pages/subAdmin/VisitDetailPage.tsx': 'export default function VisitDetailPage() { return <div>Visit Detail</div>; }',
  'src/pages/subAdmin/AvailabilityPage.tsx': 'export default function AvailabilityPage() { return <div>Availability</div>; }',
  'src/pages/subAdmin/VisitHistoryPage.tsx': 'export default function VisitHistoryPage() { return <div>Visit History</div>; }',
  'src/pages/headAdmin/AdminManagePage.tsx': 'export default function AdminManagePage() { return <div>Admin Manage</div>; }',
  'src/pages/headAdmin/AllRequestsPage.tsx': 'export default function AllRequestsPage() { return <div>All Requests</div>; }',
  'src/pages/headAdmin/SubAdminManagePage.tsx': 'export default function AllSubAdminsPage() { return <div>All Sub Admins</div>; }',
  'src/pages/headAdmin/AuditLogPage.tsx': 'export default function FullAuditLogPage() { return <div>Full Audit Log</div>; }',
};
